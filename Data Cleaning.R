...
# 1= Rural & Military; 2= Government & Police; 3= Potentilly Urban Workplace; 4= Potentilly Urban Infrastructure; 5= Potentilly Urban Core Life 
...
Plotframe1 <- data.frame(year=GTD$iyear, tup= TUP_weight_as_DAMAGE_0_up_to_1, dam= DAMAGE_0_up_to_1, tupxdamage= TUPxDAMAGE, tupanddamage= TUPandDAMAGE, region= GTD$region)
