...
```{r, echo=FALSE, warning=FALSE, results='asis', message=FALSE, fig.height=6}
...
qmap('Sri Lanka', zoom = 8,  
                   maptype = "terrain",
                   legend="none") + geom_point(aes(x = longitude, y = latitude, color=largest.UC),
                  data = srilankamap)
...
[Regresison Table](http://github.com)
