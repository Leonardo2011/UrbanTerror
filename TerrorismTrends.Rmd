...
#Loading created GTD. Due to the intensive computation processes involved, we use a before created .csv file. The code is reproducible however and can be run from "2. Pre Analysis.R"
GTD <- read.csv("TerrorData/Pregtd.csv")
```
