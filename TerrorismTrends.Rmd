...
**DV.Kilcullen:** a simple addition of all of the above
...
**IV.Urban.Share*Year:** interaction variable

**IV.Pop.Coastal.Dist:** country's population average proximity to the coast

**IV.Pop.Coastal.Dist*Year:** interaction variable
...
*"inUC": Attack is atributed to an Urban Center; "Kill.Wound": Sum of killed and wounded individuals due to the attack; "Light"", "Access"", "Prox.Coast"" and "Dens"" refer to geodata of the location.*
...
<<<<<<< HEAD
<<<<<<< HEAD
**Figure 1:** (above) Illumination levels in Turkey and example attacks
...
>>>>>>> 9fe33d0ef29b19fb102d02f538dcc9a07c44976c
---------
...
<<<<<<< HEAD
<<<<<<< HEAD
**Figure 2:** (above) Road accessibility in Turkey and example attacks
...
<<<<<<< HEAD
<<<<<<< HEAD
**Figure 3:** (above) Distance to coast of locations in Turkey and example attacks
...
<<<<<<< HEAD
<<<<<<< HEAD
**Figure 4:** (above) Population density in Turkey and example attacks
...
Political violence moves to urban, crowded, connected and littoral spaces at a higher pace than the countries population movement.
...
**Regression:** Linear, Fixed Effects Model, Country Panel Data, 1998-2013, w/o Government Targets, w/o Countries with less than 20 attacks or 40 victims
