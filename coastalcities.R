...
UrbanCenters$costalMC[UrbanCenters$City == "johor bahru"] <- "1"
UrbanCenters$costalMC[UrbanCenters$City == "stockholm"] <- "1"
UrbanCenters$costalMC[UrbanCenters$City == "changshu"] <- "1"
UrbanCenters$costalMC[UrbanCenters$City == "merida"] <- "1"
##############################################################
##############################################################
...
UrbanCenters$costalMC[UrbanCenters$City == "conakry"] <- "1"
UrbanCenters$costalMC[UrbanCenters$City == "tijuana"] <- "1"
UrbanCenters$costalMC[UrbanCenters$City == "visakhapatnam"] <- "1"
UrbanCenters$costalMC[UrbanCenters$City == "thiruvananthapuram"] <- "1"
UrbanCenters$costalMC[UrbanCenters$City == "santos"] <- "1"
UrbanCenters$costalMC[UrbanCenters$City == "vitoria"] <- "1"
UrbanCenters$costalMC[UrbanCenters$City == "montevideo"] <- "1"
UrbanCenters$costalMC[UrbanCenters$City == "perth"] <- "1"
UrbanCenters$costalMC[UrbanCenters$City == "kannur"] <- "1"
UrbanCenters$costalMC[UrbanCenters$City == "mogadishu"] <- "1"
UrbanCenters$costalMC[UrbanCenters$City == "haikou"] <- "1"
UrbanCenters$costalMC[UrbanCenters$City == "makassar"] <- "1"
UrbanCenters$costalMC[UrbanCenters$City == "marseille"] <- "1"
UrbanCenters$costalMC[UrbanCenters$City == "davao city"] <- "1"
UrbanCenters$costalMC[UrbanCenters$City == "virginia beach norfolk"] <- "1"
UrbanCenters$costalMC[UrbanCenters$City == "porto"] <- "1"
UrbanCenters$costalMC[UrbanCenters$City == "yantai"] <- "1"
UrbanCenters$costalMC[UrbanCenters$City == "natal"] <- "1"
UrbanCenters$costalMC[UrbanCenters$City == "sendai"] <- "1"
UrbanCenters$costalMC[UrbanCenters$City == "huizhou"] <- "1"
UrbanCenters$costalMC[UrbanCenters$City == "sao luis"] <- "1"
UrbanCenters$costalMC[UrbanCenters$City == "hiroshima"] <- "1"
UrbanCenters$costalMC[UrbanCenters$City == "auckland"] <- "1"
UrbanCenters$costalMC[UrbanCenters$City == "zhuhai"] <- "1"
UrbanCenters$costalMC[UrbanCenters$City == "tainan"] <- "1"
UrbanCenters$costalMC[UrbanCenters$City == "maceio"] <- "1"
UrbanCenters$costalMC[UrbanCenters$City == "copenhagen"] <- "1"
UrbanCenters$costalMC[UrbanCenters$City == "cixi city"] <- "1"
UrbanCenters$costalMC[UrbanCenters$City == "joao pessoa"] <- "1"
UrbanCenters$costalMC[UrbanCenters$City == "zhangzhou"] <- "1"
UrbanCenters$costalMC[UrbanCenters$City == "providence"] <- "1"
UrbanCenters$costalMC[UrbanCenters$City == "tripoli"] <- "1"
UrbanCenters$costalMC[UrbanCenters$City == "vasai virar"] <- "1"
UrbanCenters$costalMC[UrbanCenters$City == "helsinki"] <- "1"
...
UrbanCenters$costalMC[UrbanCenters$City == "mombasa"] <- "1"
UrbanCenters$costalMC[UrbanCenters$City == "dongying"] <- "1"
UrbanCenters$costalMC[UrbanCenters$City == "amsterdam"] <- "1"
UrbanCenters$costalMC[UrbanCenters$City == "jiaxing"] <- "1"
UrbanCenters$costalMC[UrbanCenters$City == "nantong"] <- "1"
UrbanCenters$costalMC[UrbanCenters$City == "odessa"] <- "1"
UrbanCenters$costalMC[UrbanCenters$City == "cartagena"] <- "1"
UrbanCenters$costalMC[UrbanCenters$City == "hamamatsu"] <- "1"
