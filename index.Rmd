...
=======
We know that people historically have always preferred to live at the coast, and that there is a global urbanization - people moving to the cities rather than living in villages. But Kilcullen goes further. He suggests that political violence is migrating towards the urban, crowded, connected, and littoral space faster than people are. We wanted to find out whether that may be true. Have a look at our map. What you see are bubbles that stand for cities in the Middle East: The size represents the number of inhabitants, the color indicates the victims of terrorist from 1990-2003. You can use your cursor to get more information.

<div align="center">
<iframe width="750" height="437"
>>>>>>> origin/gh-pages
...
frameborder="0" allowfullscreen>
 ...
 <br>
And now the same for 2004 until the end of our dataset in 2013. Bagdad changed the color scale with almost ten times more accumulated victims than any other city the 14 years before the war. Many would argue that the Iraq War changed the whole region dramatically. After the war's first phase ended, several groups increased their frequency of attacks on the capital. But there are other changes everywhere, have a look at Yemen and Pakistan. This is just an example of the shifting geography of political violence. We can show these developments with the help of our  dataset, but what we do it is getting a little bit more sophisticated.
...
We conduct a statistical analysis to see if over the past years, acts of political violence were in fact more likely to happen in urban and littoral environments, or it is just that people are moving to these spaces. For this, we gather data from a lot of different sources.Our main dataset is the Global Terrorism Database, a huge dataset that contains over 120,000 violent attacks since 1970 [@START2013]. Additionally, we want to know a lot about the environment in which these attacks take place. This information is not included in the GTD. So we have gathered a lot of information on cities. Some other data comes from the World Bank, some even from Wikipedia, but all our source combined include:

 * Global night light emanations captured by satellites and equality of distribution amongst population
 * Distance of every place in the world to the coastline 
 * Travel distance to the next bigger city
 * The type of landcover (forest? buildings?)
 * Population density
 * Economic activity
 * City population 
 * And the change over time for all of these 

If you have ever worked with data yourself, you probably know that most of the time you spend making it organized: Finding, gathering, cleaning, tidying, calculating, merging. All of our datasets have a lot of missing information and we needed a lot of work to align things like city and country names and find all the missing values of information.
...
To illustrate a little bit better how we learn more about these locations, have a look at the following maps. They are examples of how we gather additional information on the 120.000 incidents of political violence in the global database. The first map shows how much light communities emanate at night - a sign for peoples' access to electricity.
...
stargazer(fixed.dum1,fixed.dum2,fixed.dum3,fixed.dum4,fixed.dum5,
          ...
          align=TRUE,no.space=TRUE,dep.var.labels.include = FALSE, model.numbers = FALSE, note="Observation are means as country years")
```
