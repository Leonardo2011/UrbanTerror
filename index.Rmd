...
And now the same for 2004 until the end of our dataset in 2013. Bagdad changed the scale with over 51.000 accumulated victims dramatically. Many would argue that the Iraq War changed the region. After the first phase of the war ended, several groups increased the frequency of attacks, around the beginning of 2004, with a focus on capital. But there are other changes everywhere, have a look at Yemen and Pakistan. This is just an example of the shifting geography of political violence. We can bo that with our dataset, but it is getting much more sophisticated. 
 ...
 * The type of landcover (forest or buildings)
 * Population density
 * Economic activity
 * And the change over time for all these 
